...
function Footer() {
  return (
    <div className=" flex gap-5 w-full h-screen bg-zinc-900 p-24 font-['Test_Founders_Grotesk_X']">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Test_Founders_Grotesk_X'] ">
        <div className="headings">
          <h1 className="text-[8vw] uppercase leading-none -mb-8 tracking-tight font-semibold">
            Eye-
          </h1>
          <h1 className="text-[8vw] uppercase leading-none -mb-8 tracking-tight font-semibold">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[8vw] uppercase leading-none  font-semibold">
          Presentations-
         </h1>
